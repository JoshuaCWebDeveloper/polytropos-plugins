...
export type ProfileRuntimeState = {
  ...
  /**
   * Optional attach target lifecycle owned by the browser control service
   * (e.g. ephemeral Browser Use Cloud sessions).
   */
  attachTarget?: {
...
export type ContextOptions = {
  ...
  onStopAttachTarget?: (profile: ResolvedBrowserProfile) => Promise<{ stopped: boolean }>;
