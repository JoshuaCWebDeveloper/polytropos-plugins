import type { BrowserConfig, BrowserProfileConfig, OpenClawConfig } from "../config/config.ts";
...
export function isBrowserUseCloudPlaceholderCdpUrl(raw: string): boolean {
...
export function resolveProfile(
  ...
  const shouldSkipDerivingCdpUrl =
    driver === "clawd" && attachOnly && (isPlaceholderUrl || (hasExplicitCdpUrl && !rawProfileUrl));
