import { normalizeBrowserFormField } from "../form-fields.ts";
import { registerBrowserAgentActDownloadRoutes } from "./agent.act.download.ts";
import { registerBrowserAgentActHookRoutes } from "./agent.act.hooks.ts";
import { isActKind, parseClickButton, parseClickModifiers, } from "./agent.act.shared.ts";
import { readBody, resolveTargetIdFromBody, withPlaywrightRouteContext, SELECTOR_UNSUPPORTED_MESSAGE, } from "./agent.shared.ts";
