import { formatAriaSnapshot } from "./pw-aria-snapshot.ts";
...
import { buildRoleSnapshotFromAiSnapshot, buildRoleSnapshotFromAriaSnapshot, getRoleSnapshotStats, } from "./pw-role-snapshot.ts";
import { ensurePageState, forceDisconnectPlaywrightForTarget, getPageForTargetId, storeRoleRefsForTarget, } from "./pw-session.ts";
    ...
    const isRetryableNavigateError = (err) => {
        const msg = typeof err === "string"
            ...
            : err instanceof Error
                ...
                : "";
        return (msg.includes("frame has been detached") ||
