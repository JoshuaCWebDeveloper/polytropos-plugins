...
declare function connectBrowser(cdpUrl: string): Promise<ConnectedBrowser>;
export { connectBrowser };
declare function findPageByTargetId(browser: Browser, targetId: string, cdpUrl?: string): Promise<Page | null>;
