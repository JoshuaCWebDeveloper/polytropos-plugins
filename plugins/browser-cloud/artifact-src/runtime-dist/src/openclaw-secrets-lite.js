...
function readJsonPointer(obj, pointer) {
    if (pointer === "" || pointer === "/")
        return obj;
...
export async function resolveExecSecretRef(params) {
    ...
    if (provider.source !== "exec") {
        throw new Error(`Secret provider ${params.ref.provider} has source ${String(provider.source)} (expected exec)`);
    }
...
//# sourceMappingURL=openclaw-secrets-lite.js.map